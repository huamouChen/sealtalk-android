...
import cn.chenhuamou.contactcard.IContactCardClickListener;
import cn.chenhuamou.contactcard.IContactCardInfoProvider;
import cn.chenhuamou.contactcard.message.ContactMessage;
import cn.chenhuamou.im.db.Friend;
import cn.chenhuamou.im.message.TestMessage;
import cn.chenhuamou.im.message.provider.ContactNotificationMessageProvider;
import cn.chenhuamou.im.message.provider.TestMessageProvider;
...
import cn.chenhuamou.im.stetho.RongDatabaseDriver;
import cn.chenhuamou.im.stetho.RongDatabaseFilesProvider;
import cn.chenhuamou.im.stetho.RongDbFilesDumperPlugin;
import cn.chenhuamou.im.ui.activity.UserDetailActivity;
import cn.chenhuamou.im.ui.widget.MyExtensionModule;
import cn.chenhuamou.im.utils.SharedPreferencesContext;
...
//            LeakCanary.install(this);//内存泄露检测
            ...
            options = new DisplayImageOptions.Builder()
                    .showImageForEmptyUri(cn.chenhuamou.im.R.drawable.de_default_portrait)
                    .showImageOnFail(cn.chenhuamou.im.R.drawable.de_default_portrait)
                    .showImageOnLoading(cn.chenhuamou.im.R.drawable.de_default_portrait)
